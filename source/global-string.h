...
namespace plutobook {
    ...
    public:
        ...
        bool operator==(const GlobalString& o) const {
        ...
        friend std::size_t hash_value(GlobalString key) {
            return boost::hash<const void*>{}(key.m_entry);
        }
    ...
    inline bool operator<(const GlobalString& a, const GlobalString& b) {
    ...
    inline bool operator==(const GlobalString& a, const std::string_view& b) {
        return a.value() == b;
    }
    inline bool operator!=(const GlobalString& a, const std::string_view& b) {
        return a.value() != b;
    ...
    inline bool operator==(const std::string_view& a, const GlobalString& b) {
        return a == b.value();
    }
    inline bool operator!=(const std::string_view& a, const GlobalString& b) {
        return a != b.value();
    ...
    inline bool operator==(const GlobalString& a, const HeapString& b) {
        return a.value() == b;
    }
    inline bool operator!=(const GlobalString& a, const HeapString& b) {
        return a.value() != b;
    ...
    inline bool operator==(const HeapString& a, const GlobalString& b) {
        return a == b.value();
    }
    inline bool operator!=(const HeapString& a, const GlobalString& b) {
        return a != b.value();
