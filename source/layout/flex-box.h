...
namespace plutobook {
    enum class FlexSign { Positive, Negative };
    ...
    class FlexItem {
    public:
        FlexItem(BoxFrame* box, int order, float flexGrow, float flexShrink,
                 AlignItem alignSelf);
        ...
        float flexFactor(FlexSign sign) const {
            return sign == FlexSign::Positive ? m_flexGrow : m_flexShrink;
        }
    ...
    public:
        ...
        bool isHorizontalFlow() const {
            return m_flexDirection == FlexDirection::Row ||
                   m_flexDirection == FlexDirection::RowReverse;
        }
        bool isVerticalFlow() const {
            return m_flexDirection == FlexDirection::Column ||
                   m_flexDirection == FlexDirection::ColumnReverse;
        }
        bool isMultiLine() const {
            return m_flexWrap == FlexWrap::Wrap ||
                   m_flexWrap == FlexWrap::WrapReverse;
        }
