...
namespace plutobook {
    ...
    public:
        ...
        uint32_t assumedImplicitBreaks() const {
            return m_assumedImplicitBreaks;
        }
    ...
    public:
        static constexpr ClassKind classKind = ClassKind::MultiColumnRow;

        static MultiColumnRowBox* create(MultiColumnFlowBox* columnFlow,
    ...
    private:
        MultiColumnRowBox(MultiColumnFlowBox* columnFlow,
        ...
        float rowTopAt(uint32_t columnIndex) const {
            return m_rowTop + columnIndex * m_columnHeight;
        }
        float rowHeightAt(uint32_t columnIndex) const;

        uint32_t columnIndexAtOffset(float offset,
                                     bool clampToExistingColumns) const;
    ...
    public:
        ...
        static MultiColumnSpanBox* create(BoxFrame* box,
                                          const BoxStyle* parentStyle);
    ...
    public:
        static constexpr ClassKind classKind = ClassKind::MultiColumnFlow;
