...
namespace plutobook {
    ...
    public:
        ...
        Element* furthestBlockForFormattingElement(
            const Element* formattingElement) const;
    ...
    private:
        ...
        Element* createElement(const HtmlTokenView& token,
        ...
        void insertForeignElement(const HtmlTokenView& token,
                                  GlobalString namespaceURI);
        ...
        void handleToken(HtmlTokenView& token) {
