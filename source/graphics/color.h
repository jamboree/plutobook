...
namespace plutobook {
    ...
    public:
        ...
        constexpr Color opaqueColor() const {
            return Color(m_value | 0xFF000000);
        }
    ...
    template<>
    struct OptionalTrait<Color> {
        static constexpr Color null{0x00FFFFFF};
        static constexpr bool isNull(Color value) { return value == null; }
    };
} // namespace plutobook