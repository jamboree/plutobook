...
namespace plutobook {
    ...
    public:
        ...
        const std::string& systemIdentifier() const {
    ...
    class HtmlTokenView {
    public:
        HtmlTokenView(HtmlToken& token) : m_type(token.type()) {
            switch (m_type) {
            ...
            case HtmlToken::Type::SpaceCharacter: m_data = token.data(); break;
            default: break;
            }
        }
    ...
    public:
        ...
        bool atEOF() const {
            return m_currentToken.type() == HtmlToken::Type::EndOfFile;
        }
